...
<p class="csmi-revision">
  ...
  <a href="https://github.com/BrokkAi/code-semantic-model-interchange/tree/main">source revision <code>main</code></a>.
</p>
...
<nav class="csmi-toc" aria-labelledby="csmi-toc-title">
  <h2 id="csmi-toc-title">Contents</h2>
  <ol>
    <li>
      <a class="csmi-toc__section" href="#1-specification-architecture">1. Specification architecture</a>
      <ol>
        <li><a href="#11-layers">1.1 Layers</a></li>
        <li><a href="#12-normative-language">1.2 Normative language</a></li>
        <li><a href="#13-terminology">1.3 Terminology</a></li>
        <li><a href="#14-repository-documents">1.4 Repository documents</a></li>
      </ol>
    </li>
    <li>
      <a class="csmi-toc__section" href="#2-versioning">2. Versioning</a>
      <ol>
        <li><a href="#21-semantic-model-version">2.1 Semantic-model version</a></li>
        <li><a href="#22-serialization-version">2.2 Serialization version</a></li>
        <li><a href="#23-json-schema-version">2.3 JSON Schema version</a></li>
        <li><a href="#24-profiles-and-extensions">2.4 Profiles and extensions</a></li>
        <li><a href="#25-normative-json-mapping">2.5 Normative JSON mapping</a></li>
      </ol>
    </li>
    <li>
      <a class="csmi-toc__section" href="#3-semantic-core-sections">3. Semantic-core sections</a>
      <ol>
        <li><a href="#31-artifact-and-package-identity">3.1 Artifact and package identity</a></li>
        <li><a href="#32-symbol-identity">3.2 Symbol identity</a></li>
        <li><a href="#33-declarations">3.3 Declarations</a></li>
        <li><a href="#34-procedure-summaries">3.4 Procedure summaries</a></li>
        <li><a href="#35-completeness-and-uncertainty">3.5 Completeness and uncertainty</a></li>
        <li><a href="#36-effects-profiles-and-extensions">3.6 Effects, profiles, and extensions</a></li>
        <li><a href="#37-manifest-provenance-and-canonicalization">3.7 Manifest, provenance, and canonicalization</a></li>
      </ol>
    </li>
    <li>
      <a class="csmi-toc__section" href="#4-conformance">4. Conformance</a>
      <ol>
        <li><a href="#41-structural-conformance">4.1 Structural conformance</a></li>
        <li><a href="#42-semantic-conformance">4.2 Semantic conformance</a></li>
        <li><a href="#43-independence-requirement">4.3 Independence requirement</a></li>
        <li><a href="#44-inconclusive-and-unsupported-outcomes">4.4 Inconclusive and unsupported outcomes</a></li>
      </ol>
    </li>
  </ol>
</nav>
